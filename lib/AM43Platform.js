  ...
  configurePropertiesOnAccessory(accessory) {
    ...
    accessory.disconnectIfUninteracted = () => {
      ...
      if (
        ...
        accessory.am43device.logDebug("Disconnecting AM43 due to HAP inactivity")
        accessory.am43device.disconnectAsync()
      }
    }
  ...
  configureWindowCoveringServiceOnAccessory(accessory) {
    ...
    service
      ...
      .onGet(async () => {
        ...
        if (
          ...
          accessory.am43device.logDebug("Requesting position update", accessory.am43device.isConnected)
        ...
        accessory.am43device.logDebug("Reporting position: " + position)
        return position
      })
    ...
    service
      ...
      .onGet(() => {
        ...
        accessory.am43device.logDebug("Reporting target position: " + targetPosition)
      ...
      .onSet(async (value) => {
        ...
        accessory.am43device.logDebug("setting target position: " + targetPosition)
        try {
          ...
          accessory.am43device.logDebug(error)
        }
      })
    ...
    service
      ...
      .onGet(() => {
        ...
        accessory.lastHAPInteraction = Date.now()
        accessory.am43device.logDebug("Reporting direction: " + accessory.am43device.direction)
